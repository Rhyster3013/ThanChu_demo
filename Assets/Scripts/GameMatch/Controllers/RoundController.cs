...
{
    [SerializeField] PlayerModel currentPlayer;
    ...
    void Start()
    {
        if (gameObject.name == "Player")
        {
            ...
            Transform stageIndicator = buttons.Find("StageIndicator");
            txbStageIndicator = stageIndicator.Find("txbStageIndicator").GetComponent<TextMeshProUGUI>();

            btnNextStage = buttons.Find("btnNextStage").GetComponent<Button>();
            btnConfirm = buttons.Find("btnConfirm").GetComponent<Button>();
            btnCancel = buttons.Find("btnCancel").GetComponent<Button>();
