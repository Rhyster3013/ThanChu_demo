...
public class CardFunctions : MonoBehaviour
{
    ...
    public void Attack(PlayerModel user, PlayerModel target, int damage)
    {
    ...
    public void Dodge(PlayerModel user)
    {
    ...
    public void Heal(PlayerModel user, PlayerModel target)
    {
        func.HealHP(target);
